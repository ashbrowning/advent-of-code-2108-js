...
const solution = input => {
  ...
  const sleepiestGuard = Object.values(guards)
    .reduce((sleepiest, guard) =>
    sleepiest.totalTimeAsleep > guard.totalTimeAsleep ? sleepiest : guard,
    currentGuard);

  return sleepiestGuard.getSleepiestMinute().highestSessionStart * sleepiestGuard.id;
};
